...
class AlarmReceiver: BroadcastReceiver() {
    ...
    companion object{
        ...
        private const val CHANNEL_NAME = "GitUser Reminder"
    ...
    private fun showAlarmNotification (context: Context){
        ...
        val intent = context.packageManager.getLaunchIntentForPackage("com.caresomebody.test.submisi2fundamental")
    ...
    fun setRepeatingAlarm(context: Context, type: String, time: String, message: String){
        ...
        Toast.makeText(context, context.getString(R.string.alarm_set_up), Toast.LENGTH_SHORT).show()
    }
